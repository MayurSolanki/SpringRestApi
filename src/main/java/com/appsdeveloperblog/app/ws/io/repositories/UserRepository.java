...
@Repository
public interface UserRepository extends   PagingAndSortingRepository<UserEntity, Long> , CustomRepository { //  PagingAndSortingRepository<UserEntity,Long> {  //CrudRepository
	...
	UserEntity findByUserId(String userId);   // Generated By us , 30 Character
...
//    @Query(name = "userEntity.usersByDepartment", nativeQuery = true)
//	List<UserEntity> searchUserByDepartmentName(@Param("departmentName") String departmentName);  // Search Query
