...
public class AppExceptionHandler {
	...
	public ResponseEntity<Object> handleUserServiceException(UserServiceException userServiceException,WebRequest webRequest){
		...
		//userServiceException.getMessage() , change this value to json object of you wants object instead of String
	
		// if only string then response like be => Missing required field. Please check documentation for required fields 
...
//     if custom Object then response like be => Missing required field. Please check documentation for required fields 
	...
	// This method will handle Common null pointer exception
		...
		public ResponseEntity<Object> handleCustomException(CustomExceptionHandler customExceptionHandler,WebRequest webRequest){
